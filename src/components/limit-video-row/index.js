...
export const LimitVideoRow = (props) => {
    ...
    useEffect(() => {
        const handleResize = () => {
          ...
          if (width >= 1912) setShowSlides(8);
          else if (width >= 1679) setShowSlides(7);
          else if (width >= 1440) setShowSlides(6);
          else if (width >= 1280) setShowSlides(5);
        };
