...
export default function CommentItemChildActress(props) {
    const { avatar = '', endPublisher = {}, item } = props || {};
    const { id, text, currentLevel } = item || {};
    ...
    return (
        <div className="comment-item-child-actress">
            <div className="d-flex align-items-center justify-content-between">
                <div className="position-relative d-flex align-items-start">
                    <PopupAuthorInfo avatar={avatar} endPublisher={endPublisher} isChild={true} />
                    <span className="comment-item-author text-main-gray mt-1 whitespace-nowrap fs-5 ms-2">北京男</span>
                    <Image
                        alt='vip1'
                ...
                <div ref={dropdownRef} className="position-relative d-inline-block">
                    ...
                    {isOpenBlock &&
                        <div className="wrap-block">
                            <span className="text-white text-pink-hover px-3 py-2 whitespace-nowrap cursor-pointer" >删除评论</span>
            ...
            <div className="comment-item-content">
                    <p className="text-main-gray fs-6 mb-3">2025-10-12</p>
