...
export default function SearchJapanItem(props) {
        ...
        <div className="search-japan-item mb-5">
            ...
            <div className="search-japan-item-right">
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="search-japan-tags">
                        <span>{cid}</span>
                ...
                <div className="mt-3">
                    ...
                    <div className="text-main-gray">番号: <span className="text-color-main">{sNo}</span></div>
